      ...
      <div style={{ height: "300px" }} className='mt-5 container w-100'>
          ...
          <div className="d-flex justify-content-between">
              ...
              <div style={{ width: "400px" }}>
                  <h5 className=''><i className='fa-brands fa-docker'></i>Project Fair </h5>
              ...
              <div className="d-flex flex-column">
                  <h5>Guides</h5>
                  <a href="https://react.dev/" style={{ textDecoration: 'none', color: "black" }} target='_blind'>React</a>
                  <a href="https://reactrouter.com/en/main" style={{ textDecoration: 'none', color: "black" }} target='_blind'>React Router</a>
                  <a href="https://react-bootstrap.netlify.app/" style={{ textDecoration: 'none', color: "black" }} target='_blind'>React Bootstrap</a>
              </div>
              {/* contacts */}
              <div className="d-flex flex-column">
                  <h5>Contact</h5>
          ...
          <hr />
          <p className="text-center mt-3">Copyright &copy; Athul Krishna, Project Fair App. Build with React</p>
      </div>
  )
}
