...
const Edit = ({ project }) => { //project key in the props will hold project data to be displayed in edit compoenent
                    ...
                    <div className="row align-item-center">
                      <div className="col-lg-4 p-5">
                        <label>
                          ...
                          <img src={preview? preview:`${SERVER_BASE_URL}/uploads/${project?.projectImage}`} height={'200px'} alt="" />
                        </label>
                        {
                          !uploadFileStatus &&
